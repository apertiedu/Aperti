  ...
  const navGroups: NavGroup[] = [
    {
      ...
      items: [
        ...
        { name: "My Schedule", href: "/teacher/schedule", icon: CalendarClock, roles: ["teacher"] },
      ],
    },
    {
      label: "Teaching",
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Finance Center",          href: "/admin/finance-control-center", icon: DollarSign, roles: ["admin"] },
        { name: "Sub Analytics",           href: "/admin/subscription-analytics", icon: BarChart3,  roles: ["admin"] },
