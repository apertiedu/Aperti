const STATIC_ROUTES = new Set([
  ...
  "/skill-badge", "/learn-path",  "/revisit",
  "/focus-coach", "/focus-zone", "/trial-vault", "/peak-rankings",
  "/peer-review", "/echo", "/study-groups",
  ...
  "/admin/paper-vault", "/admin/helpdesk",
  "/admin/shield-core", 
   "/admin/subpilot",
  ...
  "/admin/executive", "/admin/push", 
  "/admin/guardian-pulse", "/admin/route-health",
