              ...
              <motion.div key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                ...
                >
                  ...
                  <button
                    type="button"
                    disabled
                    title="Google sign-in is not available on this platform"
                    className="mt-3 w-full h-11 rounded-xl border border-slate-100 bg-slate-50 text-sm font-medium text-slate-400 flex items-center justify-center gap-2.5 cursor-not-allowed opacity-50"
                  >
