              ...
              <motion.div key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                ...
                >
                  ...
                  <button
                    ...
                    className="mt-3 w-full h-11 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 text-sm font-medium text-slate-700 flex items-center justify-center gap-2.5 transition-all duration-200 hover:border-slate-300 hover:shadow-sm"
                  >
