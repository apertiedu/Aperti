...
const STUDENT_PLANS = [
  ...
  { id: "plus",     name: "Plus",      price: 149, color: "#1976D2", features: ["All Essential features", "InkSpace notes", "SimVerse labs", "Peer review access"] },
  { id: "pro",      name: "Pro",       price: 249, color: "#7B1FA2", features: ["All Plus features", "Priority AI tutor", "Practice exam library", "Progress analytics"] },
  { id: "elite",    name: "Elite",     price: 399, color: "#E65100", features: ["All Pro features", "Live class access", "Dedicated support", "Custom learning path"] },
];
