...
const MODULES = [
  ...
  { name: "Student OS", status: "stable", icon: BookOpen, version: "17.0", lastUpdated: "Phase 17", description: "Study stream, Ascend gamification, Trial Vault, Flashcard 3.0, mentor AI, focus coaching, mobile dashboards, and offline sync." },
