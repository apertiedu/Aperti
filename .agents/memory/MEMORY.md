...
- [Phase 17 Mobile Ecosystem](phase17-mobile-ecosystem.md) — responsive layout (mobile drawer), bottom nav, PWA/sw.js v3, web-push (lib/push.ts), offline IndexedDB, 4 mobile dashboards, Flashcard 3.0 swipe, admin push page; requireRole middleware does NOT exist — use inline check
